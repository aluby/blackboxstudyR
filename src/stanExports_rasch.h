...
namespace model_rasch_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rasch");
    reader.add_event(26, 24, "end", "model_rasch");
    return reader;
}

#include <stan_meta_header.hpp>
 class model_rasch : public prob_grad {
private:
    int I;
    int J;
    int N;
    ...
    vector<int> y;
public:
    model_rasch(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rasch_namespace::model_rasch";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(bernoulli_logit_log<propto__>(y, subtract(stan::model::rvalue(theta, stan::model::cons_list(stan::model::index_multi(jj), stan::model::nil_index_list()), "theta"),stan::model::rvalue(b, stan::model::cons_list(stan::model::index_multi(ii), stan::model::nil_index_list()), "b"))));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_rasch_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_rasch_namespace::model_rasch stan_model;
